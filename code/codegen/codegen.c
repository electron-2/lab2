...
// there are 6 executed for -Og and 7 for -O1. Can you come up
// with a theory to explain the performance advantage of the 
// -O1 version despite executing an additional instruction?
int part_b(void)
{
    int num = *(int *)100;
